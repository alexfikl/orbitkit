...
from orbitkit.typing import Array1D, ArrayND, Scalar
...
class Target(ABC):
    ...
    ) -> Callable[[float, Array1D[np.inexact[Any]]], Array1D[np.inexact[Any]]]:
...
) -> Callable[[Scalar | ArrayND[np.floating[Any]]], Scalar | ArrayND[np.floating[Any]]]:
