...
class WangRinzelParameter(NamedTuple):
    C: float
...
class WangRinzel:
    ...
    def __call__(self, V: Array, h: Array) -> Array:
        param = self.param
...
WANG_RINZEL_PARAMETERS = {
    "WangRinzel1992a": WangRinzelParameter(
        C=1.0,
        g_PIR=0.3,
        g_L=0.1,
        g_syn=0.3,
...
WANG_RINZEL_MODEL = {
    "WangRinzel1992a": WangRinzel(
        param=WANG_RINZEL_PARAMETERS["WANG_RINZEL_PARAMETERS"],
        minf=SigmoidRate(1.0, -65.0, 7.8),
        sinf=SigmoidRate(1.0, 0.0, 2.0),
